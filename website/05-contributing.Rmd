...
5. Fork the following repos, and clone them to your computer inside `~/git/dashboards`:
...
7. In your `~/.profile` add the following two lines:

```
export DASHBOARDS_DATA=~/git/dashboards/
...
13. Using the project menu, open the project corresponding to the automated analysis you are interested in
